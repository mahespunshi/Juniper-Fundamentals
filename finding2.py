...
code = input("Which software release are you looking for? (Example: 12.3X48-D75, 12.1X46-D10, 15.1X49-D100, 17.4R1, 18.4R1)")
...
while not search.__contains__(code) or code == '':
    ...
    code = input("Example: 12.3X48-D75, 12.1X46-D10, 15.1X49-D100, 17.4R1, 18.4R1..etc ..Please choose again:")
